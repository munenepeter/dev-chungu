    ...
    public function getLiString($lis) {
        ...
        <div class="pt-4 border-b border-gray-100 flex justify-between group/item hover:bg-gray-50">
            <div class="cursor-pointer">
                <p class="text-sm font-medium text-rose-900">{$lis[$i]->name}</p>
                <span class="text-sm text-rose-500">{$lis[$i]->abbr}</span>
                <br>
                <span class="text-xs text-rose-300">{$lis[$i]->updated_at}</span>
            </div>
                    ...
                    <div id="deleteModal{$lis[$i]->id}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                            ...
                            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                ...
                                <small class="mb-4 text-rose-500 text-xs">({$lis[$i]->name})</small>
                                <div class="mt-4 flex justify-center items-center space-x-4">
                                    ...
                                    <form id="deleteLi" action="/projects/jwg/leg-initia/delete" method="post">
                                        ...
                                        <button id="delloading" disabled type="button" class="hidden text-white bg-rose-700 hover:bg-rose-800 focus:ring-4 focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-rose-600 dark:hover:bg-rose-700 dark:focus:ring-rose-800 items-center">
                                        ...
                                        <button id='delsuccess' type="submit" class="hidden text-white items-center bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 cursor-not-allowed" disabled>
