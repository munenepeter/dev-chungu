       ...
       <div class="grid place-items-center bg-gray-100" id="main">
              <div class="max-w-sm md:max-w-lg bg-gray-100 px-4 md:px-8 py-14">
                     ...
                     <div class="bg-white shadow-xl pl-4 pb-2 pt-4 rounded-xl mt-10">
                            ...
                            <section id="lisSection" class="overflow-y-auto h-80 scrollbar-hide">
...
<script>
       window.addEventListener("load", function(event) {
              ...
              customEvent.initEvent('loadLI', true, true);

              const LiSection = document.getElementById("lisSection");


              axios.get('/projects/jwg/leg-initia/show')
                     .then(function(response) {
                            //console.log(response.data);
                            LiSection.innerHTML = response.data;
              ...
              window.addEventListener('loadLI', (e) => {
