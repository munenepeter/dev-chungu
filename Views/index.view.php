...
<?php  include_once 'sections/nav.view.php';   ?>
    <div class="text-gray-300 container mx-auto p-8 overflow-hidden md:rounded-lg md:p-10 lg:p-12">
        ...
        <p class="font-sans text-4xl font-bold text-gray-200 max-w-5xl lg:text-7xl lg:pr-24 md:text-6xl">
            Your Ultimate Reliable developer
        </p>
        <div class="h-10"></div>
        ...
        <p class="font-serif text-4xl">
            ...
            <span class="text-gray-600">consectetur adipisicing elit. Consectetur atque molestiae omnis
                excepturi enim!</span>
        </p>
        ...
        <div class="grid gap-4 md:grid-cols-4">
            ...
            <ul class="space-y-1 text-gray-400">
                ...
                <li>
                    <a href="https://github.com/gary149/landing-gradients" class="self-start px-3 py-2 leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-none focus:shadow-outline bg-gradient-to-b hover:from-indigo-500 from-gray-900 to-black">
                        Get this template
                    </a>
                </li>
            </ul>
