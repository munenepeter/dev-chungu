                            ...
                            <?php foreach ($projects as $project) : ?>
                                   ...
                                   <article class="max-w-sm rounded-lg hover:shadow-md">
                                          ...
                                          <div class="p-2 mt-2 border-b border-rose-100 hover:border-rose-300 rounded-b-md hover:bg-purple-50">
                                                 ...
                                                 <a href="#">
                                                        <h5 class="mb-2 text-purple-900 hover:underline font-bold"><?= $project['name'] ?></h5>
                                                 </a>
                                                 <p class="mb-3 text-sm text-gray-500"><?= $project['description'] ?></p>

                                                 <a href="projects/<?= $project['category'] . '/' . $project['name'] ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-700 rounded-lg hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">
                                                        Live Preview
