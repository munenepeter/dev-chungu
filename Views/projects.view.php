...
<main class="py-6 my-8">
       <section class="mx-auto max-w-screen-2xl mt-6">
              <h2>All Projects</h2>
                     <div class="px-2 flex flex-wrap mt-2 gap-2 mx-auto">
                     ...
                     <h2 class="tracking-widest text-2xl text-center title-font font-medium text-purple-900 mt-8">For More projects you can visit my <a class="text-indigo-500" href="https://github.com/munenepeter">Github</a> page</h2>
