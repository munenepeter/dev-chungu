...
<main class="py-6 my-8">
       <section class="mx-auto max-w-screen-2xl mt-6 px-4">
              ...
              <div class="mt-6 grid md:grid-cols-4 grid-cols-1 mt-2 gap-2 mx-auto">
                     <?php foreach ($projects as $project) : ?>
                            <div class=" shadow-sm border border-purple-100 hover:border-purple-200   p-4 rounded-md hover:bg-purple-100 hover:shadow-md">
                                   <div class="flex justify-between items-center mb-4">
                                          ...
                                          <div class="hidden hover:inline-flex">
                                                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
