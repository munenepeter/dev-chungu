        ...
        <section class="flex justify-between px-2 mx-auto max-w-screen-2xl ">
            <article class="mx-auto w-full max-w-4xl format format-sm sm:format-base lg:format-lg format-purple dark:format-invert">
                ...
                <section id="myTabContent">
                    <div class="hidden p-2 rounded-lg bg-gray-100 dark:bg-gray-800" id="document" role="tabpanel" aria-labelledby="document-tab">
                        ...
                        <form method="post" id="doc-form" enctype="multipart/form-data" class="flex flex-row justify-center items-center">
                            ...
                            </div> <!-- FORM --> <input class="mr-2 block w-3/4 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type='file' name="files" accept=".xlsx,.xls,.doc, .docx,.ppt, .pptx,.txt,.pdf" /> <button name="submitpdf" type="submit" id="submitpdf" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Parse</button>
                        </form>
