...
<body>
            ...
            <article class="mx-auto w-full max-w-4xl format format-sm sm:format-base lg:format-lg format-purple dark:format-invert">
                ...
                <div class=" p-2 rounded-lg bg-gray-100 dark:bg-gray-800">
                    <p id="doc-label" class="text-lg text-center font-medium text-gray-900 dark:text-white">Welcome
                        to Excel-JSON</p> <label id="doc-label-guide" class="block mb-2 text-sm text-center text-gray-500 " for="file_input">Select document to convert</label>
                    ...
                    <section id="doc-content" class="mt-4 p-2 rounded-lg bg-white">
                        <div id="content" class="p-2 overflow-y-auto ">
                            <p class="my-4 text-sm font-medium italic text-green-400" id="response"></p>
                        </div>
                    </section>
                </div>
    ...
    <!-- <nav class="pt-2 pb-2 mb-2 bg-gray-50 border border-gray-100 px-2 sm:px-4 py-2.5 rounded">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            <div class="m-auto w-full  md:w-auto text-purple-700 text-3xl">
    ...
    <div class="m-4 md:m-auto p-6 max-w-lg bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <form method="post" enctype="multipart/form-data" id="fileForm">
            ...
            <div class="my-4 text-sm text-center text-gray-500" id="inputfile_help">Please make sure you upload an excel
                document</div>
            <center>
                <button name="submit" type="button" class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" id="convert">Convert</button>
