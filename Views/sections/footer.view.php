    ...
    <div class=" pt-2">
      ...
      max-w-screen-lg items-center">
            <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
                <a target="_blank" rel="noopener noreferrer" href="https://www.pinterest.com/chungucollections/" class="w-6 mx-1" title="Pinterest">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-green-550 hover:text-pink-550" fill="currentColor" viewBox="0 0 32 32" class="w-4 h-4">
                ...
                <a target="_blank" href="https://tiktok.com/chungucollections" class="w-6 mx-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" class="w-6 h-6 text-green-550 hover:text-pink-550">
                        <path d="M9 4C6 4 4 6 4 9v32c0 3 2 5 5 5h32c3 0 5-2 5-5V9c0-3-2-5-5-5H9zm0 2h32c2 0 3 1 3 3v32c0 2-1 3-3 3H9c-2 0-3-1-3-3V9c0-2 1-3 3-3zm17 4a1 1 0 0 0-1 1v20c0 1-2 3-4 3l-3-3c0-2 2-4 3-4h1a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1h-1a10 10 0 1 0 10 10V21a8 8 0 0 0 6 2 1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1c-3-1-6-3-6-6a1 1 0 0 0-1-1h-4zm1 2h2c1 3 4 6 7 6v3c-2 0-4-1-5-3a1 1 0 0 0-2 1v12a8 8 0 1 1-15 0c0-4 3-8 7-8v2c-3 1-5 3-5 6 0 2 3 5 5 5 3 0 6-2 6-5V12z" />
                    </svg>
                </a>
                <a target="_blank" href="https://twitter.com/chungucoll" class="w-6 mx-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="w-6 h-6 text-green-550 hover:text-pink-550">
                ...
                <a target="_blank" href="https://www.facebook.com/chungucollections/" class="w-6 mx-1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-6 h-6 text-green-550 hover:text-pink-550">
                        <path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
                    </svg>
                </a>
                <a href="https://www.instagram.com/chungucollections/" class="w-6 mx-1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-6 h-6 text-green-550 hover:text-pink-550">
