<nav class="bg-white shadow">
    <div class="container flex flex-wrap justify-between items-center mx-auto p-6">
        ...
        <div class="inline-flex items-center justify-center px-3 py-2 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 ">Hire Us</div>
    </div>
</nav>
